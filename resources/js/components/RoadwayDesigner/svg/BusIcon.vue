<template>
  <svg
    ...
    version="1.1"
    id="Layer_1"
    enable-background="new 0 0 210.476 225.987"
    width="11%"
    height="11%"
    viewBox="0 0 25 26"
    xml:space="preserve"
  ...
  >
    <path
      ...
      fill="#black"
    />
    <circle cx="8.5" cy="14.5" r="1.5" fill="#black" />
    ...
    <g clip-path="url(#MyClipBus)">
      <rect :style="cssObject" width="100%" height="100%"></rect>
    </g>
  </svg>
</template>
<script>
export default {
  ...
  computed: {
    cssObject: function() {
      var styleObject = {
        transform:
          "translateY(" + (100 - (this.value / this.maxCapacity) * 100) + "%) ",
        fill: "green",
